...
var q1 = new QuizQuestion("On what date did the one-year timeline for timely correction begin?",
              [ new QuizAnswer("March 1, 2008"),
                new QuizAnswer("January 1, 2009"),
                new QuizAnswer("July 1, 2008") ],
              "March 1, 2008 was the date on which the State notified the EIS program of the noncompliance."
          );
...
var q2 = new QuizQuestion("By what date must the State verify correction of the finding in order to report that the finding was timely corrected?",
              [ new QuizAnswer("March 1, 2009"),
                new QuizAnswer("February 2, 2010"),
                new QuizAnswer("January 1, 2009"),
                new QuizAnswer("January 1, 2010") ],
              "March 1, 2009 is one year after the date on which the State notified the LEA of the noncompliance."
          );
...
var q3 = new QuizQuestion("In which FFY did the State make the finding of noncompliance?",
              [ new QuizAnswer("FFY 2007"),
                ...
                new QuizAnswer("FFY 2009"),
                new QuizAnswer("FFY 2008") ],
              "The state notified the LEA of the noncompliance on March 1, 2008, which is during the FFY 2007 (July 1, 2007-June 30,2008)."
          );
